...
<p class="title">Work Experience</p>
     ...
     <ul>
       ...
       customers' questions and addressed problems and complaints in person and via phone.
       </li>
       <li>
...
<ul>
  <li>
  Assisted internal employees with issues relating to software and hardware performance and other issues.
  </li>
  <li>
  Provided helpdesk support and resolve problems to the end user's satisfaction. Monitored and responded
quickly and effectively to requests received through the IT helpdesk.
  </li>
</ul>
<h1>Revature - Java Developer</h1>
<h3>December 2019 - February 2020</h3>
<ul>
  <li>
  Designed and developed various in-house software applications for clients utilizing cloud computing, Java 8,
and PostgreSQL
  </li>
  <li>
